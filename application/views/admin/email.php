        ...
        <div id="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            <div>
              ...
              <form action="<?php echo site_url('proses/sendEmail') ?>" method="post">
                ...
                <table>
                    ...
                    <td>
                      <?php if ($row['barang']==1): ?>
                        <input type="hidden" name="produk_name" value="<?php echo $row['nama_produk'] ?>">
                        <?php else: ?>
                          <?php $total = (int)$row['barang']-1; ?>
                        <input type="hidden" name="produk_name" value="<?php echo $row['nama_produk'] .' Dan '.$total.' Lainnya...' ?>">
                      <?php endif; ?>
                  ...
                  <tr>
                    <td>NAMA PENERIMA</td>
                    <td><input type="text" value="<?php echo $row['nama'] ?>" readonly></td>
                  </tr>
                  <!-- <td><input type="submit" value="Simpan" class="btn btn-success"></td> -->
                </tr>
              </table>
              <?php endforeach; ?>
              <button type="submit" class="btn btn-primary">Kirim</button> <a class="btn btn-primary" href="<?php echo base_url('jlb-order') ?>">Batal</a>
            </form> 
